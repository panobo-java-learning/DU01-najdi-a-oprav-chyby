...
public class Main {
    ...
    public static void ukol5() {
        ...
        System.out.println("\nJak to udelat, kdyz zrovna netouzime importovat BigDecimal:");
        System.out.println(String.format("%.1f", cena));
        System.out.println();
        // Má vypsat "1.0". Ale vypíše "0.9999" !!!

        // nebo kdyz z nejakeho duvodu potrebujeme BigDecimal (napr. pocitame financni castky)
